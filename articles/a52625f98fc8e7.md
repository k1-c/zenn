...
しかし、`nuxt/storybook`がまだ[Nuxt3に対応していない](https://github.com/nuxt-community/storybook/issues/330)とのことことなので、今回は`storybook/vue3`と、`storybook-builder-vite`を使って対応していきます。
